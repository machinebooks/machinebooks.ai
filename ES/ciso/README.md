# El CISO y la Máquina — Código de ejemplo

> **Gobernanza de seguridad con IA**

Código extraído de los capítulos en español del libro **"El CISO y la Máquina"** de Carlos Pérez González y Juan Carlos Montes Senra.
...
- **Español**: *El CISO y la Máquina* — Carlos Pérez González y Juan Carlos Montes Senra
