...
# Orden crítico: específico → general (pii_redactor.py:25-55)
_REDACT_PATTERNS: list[tuple[re.Pattern, str]] = [
    # Primero: claves y secretos técnicos (formato fijo)
