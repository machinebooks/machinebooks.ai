...
# Selección y notificación del FinOps Champion mensual.
# El proceso es transparente: los criterios son públicos.
...
class CandidatoChampion:
    ...
    eficiencia_actual: float   # ROI: valor/coste
    eficiencia_anterior: float
    mejora_eficiencia_pct: float
    ahorro_absoluto_eur: float
    logro_principal: str       # Descripción legible del logro


class FinOpsChampionSelector:
    """
    Selecciona el FinOps Champion del mes basándose en mejora de eficiencia,
    no en menor coste absoluto.
    """
    ...
    def calcular_eficiencia_squad(
        ...
        """Devuelve (coste_eur, valor_generado_eur) para un squad en un mes."""
    ...
    def seleccionar_champion(self, mes_actual: date) -> Optional[CandidatoChampion]:
        """
        Selecciona el squad con mayor mejora de eficiencia respecto al mes anterior.
        Requiere que el squad haya tenido actividad en ambos meses.
        """
        ...
        # Obtener todos los squads activos en el mes actual
        squads_activos = (
        ...
        for (squad,) in squads_activos:
            ...
            # Solo comparar squads con actividad en ambos meses
            ...
            if mejora_pct > mejor_mejora:
                ...
                mejor_candidato = CandidatoChampion(
                    ...
                    logro_principal=(
                        f"Mejoró eficiencia en {mejora_pct:.0f}% "
                        f"(de {eficiencia_anterior:.1f}x a {eficiencia_actual:.1f}x ROI)"
                    ),
                )
