...
async def get_service_total_cost(service_name: str, year: int, month: int) -> dict:
    """
    Coste total de un servicio: LLM API + infraestructura cloud.
    Unifica dos fuentes de datos: LLMUsageLog (MySQL) + Cost Explorer (AWS).
    """
    # Coste LLM desde MySQL
    ...
    # Coste cloud desde AWS Cost Explorer (por tag service=service_name)
