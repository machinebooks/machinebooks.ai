# El DevSecOps y la Máquina — Código de ejemplo

> **Seguridad en el pipeline con IA**

Código extraído de los capítulos en español del libro **"El DevSecOps y la Máquina"** de Carlos Pérez González.
...
- **Español**: *El DevSecOps y la Máquina* — Carlos Pérez González
