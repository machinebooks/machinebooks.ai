# El Consultor y la Máquina — Código de ejemplo

> **Consultoría aumentada con IA**

Código extraído de los capítulos en español del libro **"El Consultor y la Máquina"** de Carlos Pérez González.
...
- **Español**: *El Consultor y la Máquina* — Carlos Pérez González
