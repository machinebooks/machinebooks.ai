# El Usuario y la Máquina — Código de ejemplo

> **Agentes IA para tu trabajo diario**

Código extraído de los capítulos en español del libro **"El Usuario y la Máquina"** de Carlos Pérez González.
...
- **Español**: *El Usuario y la Máquina* — Carlos Pérez González
