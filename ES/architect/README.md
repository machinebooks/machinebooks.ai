# El Arquitecto y la Máquina — Código de ejemplo

> **Decisiones, código y lecciones de un proyecto de IA empresarial**

Código extraído de los capítulos en español del libro **"El Arquitecto y la Máquina"** de Carlos Pérez González y Juan Carlos Montes Senra.
...
- **Español**: *El Arquitecto y la Máquina* — Carlos Pérez González y Juan Carlos Montes Senra
- **Inglés**: versión en inglés disponible en Amazon
