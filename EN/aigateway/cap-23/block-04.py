...
# gateway/app/api/v1/admin/compliance.py:40-128 (excerpt)
...
async def get_moderation_report(
    ...
    """Generates moderation report for DSA compliance."""
    conds = []
    if period_start:
    ...
    # Breakdown by category, action taken, and severity
    ...
    # ... aggregation and return (see full source code)
