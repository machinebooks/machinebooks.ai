...
# gateway/app/services/dual_cache.py:33-79 (synthesized)
class InMemoryCache:
    ...
    async def get(self, key: str) -> Any | None:
        ...
        if expires_at < time.time():
            self._store.pop(key, None)  # deferred cleanup of expired entries
            return None
        self._store.move_to_end(key)  # touch for LRU
        return value
