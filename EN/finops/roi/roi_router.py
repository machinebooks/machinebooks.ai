...
# Pattern: FastAPI endpoints for ROI data

# routers/roi.py — FastAPI endpoints for ROI
...
def get_roi_summary(
    ...
    """ROI summary with breakdown by task type."""
...
def record_task_completion(
    ...
    """Manually records a task completion."""
    tracker = ROITracker(db)
    ...
    if result is None:
        return {"error": "No reference configuration for this task"}
    return {
