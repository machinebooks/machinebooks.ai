...
# Pattern: ROI calculation including engineering investment

# Cumulative ROI calculation with engineering investment
def calculate_cumulative_roi(
    db: Session, engineering_investment_eur: float, start_date: datetime,
) -> dict:
    """Cumulative ROI from project start, including engineering."""
