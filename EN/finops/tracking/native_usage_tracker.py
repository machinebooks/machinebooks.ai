...
# Pattern: Native Anthropic SDK usage tracker
...
class NativeClientUsageTracker:
    """
    Wrapper over anthropic.AsyncAnthropic.
    Captures cache_creation_input_tokens and cache_read_input_tokens
    directly from the native SDK response.
    """
    ...
    async def create_message(
        ...
        **kwargs,
        ...
        """
        Equivalent to client.messages.create() with automatic tracking.
        """
        ...
        # The native SDK exposes caching fields directly
    ...
    async def _persist_native_log(
        ...
        try:
            # The native SDK exposes these fields directly in usage
            ...
            logging.getLogger(__name__).warning(
                f"NativeClientUsageTracker: persistence error: {exc}"
            )
