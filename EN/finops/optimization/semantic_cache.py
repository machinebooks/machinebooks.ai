...
# Pattern: Semantic cache for LLM responses
...
class SemanticCache:
    """
    Semantic cache based on embeddings and cosine similarity.
    Complements Anthropic's prompt caching for queries that are
    ...
    def __init__(
        ...
        # In production, use Redis or Qdrant; simplified here
    ...
    def lookup(
        ...
        """
        Searches the cache for a semantically equivalent response.
        Returns the cached response or None if there is no hit.
        """
    ...
    def store(
        ...
        # Evict old entries if the limit is exceeded
    ...
    def _evict_oldest(self):
        """Removes the oldest entries that exceed the limit."""
