...
# Pattern: CFO-level dashboard endpoint

# routers/dashboard.py — Leadership level endpoint
@router.get("/cfo")
async def get_cfo_metrics(months: int = Query(6, ge=1, le=24)):
    """
    Monthly trend in EUR for leadership.
    No mention of tokens or models: business vocabulary.
    """
    USD_TO_EUR = 0.92  # Configurable factor, ideally from DB
