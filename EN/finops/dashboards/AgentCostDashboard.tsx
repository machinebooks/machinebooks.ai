...
// Pattern: Agent cost dashboard React component

// components/AgentCostDashboard.tsx
// Dashboard for monitoring agent costs in real time.
...
interface AgentSession {
  ...
  num_llamadas: number;
  estado: "activa" | "completada" | "stopped_by_budget";
...
export const AgentCostDashboard: React.FC = () => {
  ...
  const colorEstado = (s: AgentSession) => {
    if (s.estado === "stopped_by_budget") return "text-red-600";
  ...
  return (
    <div className="agent-dashboard p-4">
      <h2 className="text-xl font-bold mb-4">
        Autonomous Agents — Real-Time Cost
      </h2>
      {sesiones.map((s) => (
